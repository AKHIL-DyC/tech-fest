    ...
    <div className={styles.mainContainer}> 
      <animated.div className={styles.imgContainer}ref={ref} style={...springs}>
        ...
        <div><Image src={show} className={styles.img} alt='competion' onClick={toggle4}></Image></div>
         ...
         <div className={styles.textContainer} style={{display:isvisible?'block':'none'}}  ><h1>PHOTOGRAPHY</h1><p>Colorful ambience, vibrant and festive atmosphere and a thousand faces that reveal a lot of emotions! Freeze moments with your captures. Mecel 20122 is a photographer's dream, the opportunity to let your lens speak for you!
Instant Photography, Mecel 2022’s main photo-capturing competition, gives a platform for the photographer in you to shine. With Mecel spanning three days, let your creative side run wild and click pictures from a new perspective.</p></div>  
...
In an exciting test of speed and control, it all comes down to the survival of the fittest - based off competitive sport fighting formats, the winner will be chosen after multiple elimination based one-on-one battles. It's time to find out- can your bot stand the test of strength, skill and time?
...
Invoke the spirit of the GOAT's and dribble your way through defences while playing killer passes and hitting suui's while bringing home the cup like Argentina.
It's time to polish the boots, set your aim, and shoot for a chance at glory.
